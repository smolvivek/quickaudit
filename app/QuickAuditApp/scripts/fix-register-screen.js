/**
 * Script to fix TypeScript errors in RegisterScreen
 */
...
// Fix RegisterScreen.tsx
const fixRegisterScreen = () => {
...
export default RegisterScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'RegisterScreen.tsx'), content, 'utf8');
  console.log('Fixed RegisterScreen.tsx');
};

// Run the function
console.log('Fixing RegisterScreen...');
fixRegisterScreen();
console.log('RegisterScreen fixed successfully!');
