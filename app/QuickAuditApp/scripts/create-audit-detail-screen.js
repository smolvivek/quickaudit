/**
 * Script to create AuditDetailScreen
 */
...
// Create AuditDetailScreen
const createAuditDetailScreen = () => {
...
export default AuditDetailScreen;`;
  ...
  fs.writeFileSync(path.join(screensDir, 'AuditDetailScreen.tsx'), content, 'utf8');
  console.log('Created AuditDetailScreen.tsx');
};

// Run the function
console.log('Creating AuditDetailScreen...');
createAuditDetailScreen();
console.log('AuditDetailScreen created successfully!');
