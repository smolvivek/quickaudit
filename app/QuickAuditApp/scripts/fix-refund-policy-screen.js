/**
 * Script to fix TypeScript errors in RefundPolicyScreen
 */
...
// Fix RefundPolicyScreen.tsx
const fixRefundPolicyScreen = () => {
...
export default RefundPolicyScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'RefundPolicyScreen.tsx'), content, 'utf8');
  console.log('Fixed RefundPolicyScreen.tsx');
};

// Run the function
console.log('Fixing RefundPolicyScreen...');
fixRefundPolicyScreen();
console.log('RefundPolicyScreen fixed successfully!');
