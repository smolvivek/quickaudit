/**
 * Script to fix TypeScript errors in ReportSummaryScreen
 */
...
// Fix ReportSummaryScreen.tsx
const fixReportSummaryScreen = () => {
...
export default ReportSummaryScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'ReportSummaryScreen.tsx'), content, 'utf8');
  console.log('Fixed ReportSummaryScreen.tsx');
};

// Run the function
console.log('Fixing ReportSummaryScreen...');
fixReportSummaryScreen();
console.log('ReportSummaryScreen fixed successfully!');
