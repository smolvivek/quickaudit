/**
 * Script to fix TypeScript errors in AdminDashboardScreen
 */
...
export default AdminDashboardScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'AdminDashboardScreen.tsx'), content, 'utf8');
  console.log('Fixed AdminDashboardScreen.tsx');
};

// Run the function
console.log('Fixing AdminDashboardScreen...');
fixAdminDashboardScreen();
console.log('AdminDashboardScreen fixed successfully!');
