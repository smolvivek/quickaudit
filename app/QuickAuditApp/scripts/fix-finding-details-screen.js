/**
 * Script to fix TypeScript errors in FindingDetails screen
 */

const fs = require('fs');
const path = require('path');

// Fix FindingDetails.tsx
const fixFindingDetailsScreen = () => {
  const filePath = path.join(process.cwd(), 'src/screens/FindingDetails.tsx');
...
export default FindingDetails;`;
  ...
  console.log('Fixed FindingDetails.tsx');
};

// Run the function
console.log('Fixing FindingDetails screen...');
fixFindingDetailsScreen();
console.log('FindingDetails screen fixed successfully!');
