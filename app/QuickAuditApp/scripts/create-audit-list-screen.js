/**
 * Script to create AuditListScreen
 */
...
// Create AuditListScreen
const createAuditListScreen = () => {
...
export default AuditListScreen;`;
  ...
  fs.writeFileSync(path.join(screensDir, 'AuditListScreen.tsx'), content, 'utf8');
  console.log('Created AuditListScreen.tsx');
};

// Run the function
console.log('Creating AuditListScreen...');
createAuditListScreen();
console.log('AuditListScreen created successfully!');
