/**
 * Script to fix SettingsContext.tsx TypeScript errors
 */

const fs = require('fs');
const path = require('path');

// Fix SettingsContext.tsx
const fixSettingsContext = () => {
  const filePath = path.join(process.cwd(), 'src/contexts/SettingsContext.tsx');
...
export default SettingsContext;`;
  ...
  console.log('Fixed SettingsContext.tsx');
};

// Run the function
console.log('Fixing SettingsContext...');
fixSettingsContext();
console.log('SettingsContext fixed successfully!');
