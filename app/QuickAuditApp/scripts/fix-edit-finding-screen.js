/**
 * Script to fix TypeScript errors in EditFinding screen
 */
...
export default EditFindingScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'EditFinding.tsx'), content, 'utf8');
  console.log('Fixed EditFinding.tsx');
};

// Run the function
console.log('Fixing EditFinding screen...');
fixEditFindingScreen();
console.log('EditFinding screen fixed successfully!');
