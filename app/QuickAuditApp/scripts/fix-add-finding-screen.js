/**
 * Script to fix TypeScript errors in AddFindingScreen
 */
...
// Fix AddFindingScreen.tsx
const fixAddFindingScreen = () => {
  const filePath = path.join(process.cwd(), 'src/screens/AddFindingScreen.tsx');
...
export default AddFindingScreen;`;
  ...
  console.log('Fixed AddFindingScreen.tsx');
};

// Run the function
console.log('Fixing AddFindingScreen...');
fixAddFindingScreen();
console.log('AddFindingScreen fixed successfully!');
