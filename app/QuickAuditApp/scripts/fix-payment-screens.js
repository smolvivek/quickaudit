/**
 * Script to fix TypeScript errors in payment method screens
 */
...
// Fix PaymentMethodScreen.tsx
const fixPaymentMethodScreen = () => {
  const filePath = path.join(process.cwd(), 'src/screens/PaymentMethodScreen.tsx');
      ...
      <View style={styles.content}>
          ...
          <Card style={styles.card}>
            <Card.Content>
              <Text style={styles.infoText}>
                You will be redirected to PayPal to complete your payment when you make a purchase.
              </Text>
            </Card.Content>
          </Card>
        )}
        ...
        {paymentMethod === 'razorpay' && (
          <Card style={styles.card}>
            <Card.Content>
              <Text style={styles.infoText}>
                You will be redirected to Razorpay to complete your payment when you make a purchase.
              </Text>
            </Card.Content>
          </Card>
        )}
...
export default PaymentMethodScreen;`;
  ...
  console.log('Fixed PaymentMethodScreen.tsx');
};

// Fix subscription PaymentMethodScreen.tsx
const fixSubscriptionPaymentMethodScreen = () => {
...
export default PaymentMethodScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'PaymentMethodScreen.tsx'), content, 'utf8');
  console.log('Fixed subscription/PaymentMethodScreen.tsx');
};

// Run all functions
console.log('Fixing payment method screens...');
fixPaymentMethodScreen();
fixSubscriptionPaymentMethodScreen();
console.log('Payment method screens fixed successfully!');
