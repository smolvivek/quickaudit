/**
 * Script to fix TypeScript errors in ResetPasswordScreen
 */
...
// Fix ResetPasswordScreen.tsx
const fixResetPasswordScreen = () => {
...
export default ResetPasswordScreen;`;
  ...
  fs.writeFileSync(path.join(dirPath, 'ResetPasswordScreen.tsx'), content, 'utf8');
  console.log('Fixed ResetPasswordScreen.tsx');
};

// Run the function
console.log('Fixing ResetPasswordScreen...');
fixResetPasswordScreen();
console.log('ResetPasswordScreen fixed successfully!');
