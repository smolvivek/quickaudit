...
const AddFindingScreen = ({ route, navigation }) => {
  ...
  const handlePhotoPick = async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert('Permission Denied', 'Please grant camera roll permissions to add photos');
        return;
      }
  ...
  const handleLocationPick = async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert('Permission Denied', 'Please grant location permissions to add location');
        return;
      }
        ...
        {options.map(option => (
          <TouchableOpacity
            ...
            style={[
              ...
              formData[field] === option.value && field === 'severity' && { backgroundColor: option.color },
            ]}
          ...
          >
            <Text
              style={[
                ...
                formData[field] === option.value && styles.optionButtonTextSelected,
              ]}
            >
              {option.label}
            </Text>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={[styles.input, styles.textArea, errors.recommendation && styles.inputError]}
